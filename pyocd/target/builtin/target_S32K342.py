...
class S32K342(S32K3XX):
    ...
    def reset(self, reset_type=None):
        super(S32K342, self).reset(self.ResetType.SW_VECTRESET)

    def reset_and_halt(self, reset_type=None, map_to_user=True):
        super(S32K342, self).reset_and_halt(self.ResetType.SW_VECTRESET)

    def create_init_sequence(self):
        seq = super(S32K342, self).create_init_sequence()
